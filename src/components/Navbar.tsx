...
const Navbar = () => {
    const user: any = {name: "Dave Rach", email: "dave@example.com", isAdmin: true}
            ...
            <div className="w-full flex items-center justify-end gap-4 lg:gap-10">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button className="relative p-2 rounded-xl" onClick={() => setIsCartOpen(true)}>
                        ...
                        {cartCount > 0 && <span className="absolute -top-1 -right-1 size-4 bg-app-orange text-white 
                    ...
                    <div className="relative">
                        ...
                        : (
                            <div className="flex-center gap-2">
                                <Link to='/login' className="hidden md:flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-green-950 
