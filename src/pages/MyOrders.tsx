              ...
              hover:shadow transition-all">
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex items-center gap-2">
                    <span className={`px-4 py-1 text-xs font-medium rounded-full ${statusColors[order.status] || "bg-gray-100 text-green-700"}`}>
                      {order.status} 
                    </span>
                ...
                <div className="flex items-center gap-2 mb-3">
                  ...
                  {order.items.length > 4 && <div className="size-12 sm:size-16 rounded-lg bg-app-cream flex-center text-xs
